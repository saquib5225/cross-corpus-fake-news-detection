...
def css():
 st.markdown("""<style>.stApp{background:#091321;color:#eef3fb}[data-testid="stSidebar"]{background:#0d1929;border-right:1px solid #263853}h1,h2,h3{letter-spacing:-.025em;color:#f6f8fc}.hero{padding:3rem;border:1px solid #304866;border-radius:20px;background:#10213a;margin:.25rem 0 1.35rem}.eyebrow{color:#48c0af;font-size:.78rem;font-weight:750;letter-spacing:.13em;text-transform:uppercase}.hero h1{font-size:clamp(2.2rem,4vw,3.6rem);line-height:1.04}.hero p,.card p{color:#c7d3e4;line-height:1.6}.card,.metric{background:#111d30;border:1px solid #293b56;border-radius:14px;padding:1.15rem;height:100%}.model{border-top:3px solid #48c0af}.label,.small{color:#afbdd0;font-size:.78rem}.value{font-size:1.65rem;font-weight:750}.note{color:#8ee0d1;font-size:.83rem}.callout{border-left:4px solid #48c0af;background:#102439;padding:1rem;border-radius:0 10px 10px 0;margin:1rem 0}.warning{border-left-color:#edb06b;background:#292016}.danger{border-left-color:#ee8995;background:#2b1922}.step{border:1px solid #304866;border-radius:12px;padding:.85rem;background:#0f1d31;min-height:95px;text-align:center}.step b{display:block;color:#8ee0d1;margin-bottom:.3rem}.real{color:#82e1cb;font-size:1.5rem;font-weight:800}.fake{color:#ff9fa8;font-size:1.5rem;font-weight:800}.stButton>button{border:0;border-radius:9px;background:#48c0af;color:#06181a;font-weight:750}.intro-wrap{max-width:900px;margin:1rem auto 0;text-align:center;padding:clamp(1.5rem,5vw,4rem) clamp(1rem,5vw,4rem);border:1px solid #304866;border-radius:22px;background:linear-gradient(145deg,#10213a,#0d1b2e)}.intro-kicker{color:#8ee0d1;font-weight:800;letter-spacing:.16em;font-size:clamp(.85rem,2vw,1.1rem)}.intro-wrap [data-testid="stImage"]{display:flex;justify-content:center}.intro-wrap img{object-fit:contain;margin:1.5rem auto .75rem}.intro-rule{height:1px;background:#395574;max-width:470px;margin:.75rem auto 1.7rem}.intro-programme{color:#c7d3e4;font-size:clamp(1rem,2vw,1.25rem);letter-spacing:.04em}.intro-title{font-size:clamp(1.7rem,4vw,3rem);line-height:1.12;margin:1rem auto;max-width:760px}.intro-type{color:#8ee0d1;font-size:1rem;letter-spacing:.08em;text-transform:uppercase;margin:1.5rem 0}.intro-details{display:grid;gap:.45rem;color:#eef3fb;font-size:1.02rem;margin:1.5rem auto;max-width:430px}.intro-details span{color:#9fb1c7;display:inline-block;min-width:145px;text-align:right;margin-right:.45rem}.intro-note{text-align:left;max-width:700px;margin:2rem auto 0;font-size:.86rem}</style>""",unsafe_allow_html=True)
...
def introduction():
 ...
 st.markdown('<div class="intro-kicker">DUBLIN BUSINESS SCHOOL</div>',unsafe_allow_html=True)
 ...
 st.markdown('<div class="intro-details"><div><span>Student:</span> Saquib Pirjade</div><div><span>Student Number:</span> 20079780</div><div><span>Institution:</span> Dublin Business School</div></div>',unsafe_allow_html=True)
 st.markdown('<div class="callout intro-note"><b>Academic research demonstration.</b> Results shown are based on the frozen experimental evaluation described in the dissertation. Live predictions are not factual verification and are separate from the completed research evaluation.</div>',unsafe_allow_html=True)
